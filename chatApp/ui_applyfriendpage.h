...
public:
    ...
    void setupUi(QWidget *ApplyFriendPage)
    {
        ...
        ApplyFriendPage->resize(480, 640);
        ...
        horizontalSpacer = new QSpacerItem(404, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
    ...
    void retranslateUi(QWidget *ApplyFriendPage)
    {
        ...
        friend_apply_lb->setText(QCoreApplication::translate("ApplyFriendPage", "New friends", nullptr));
    } // retranslateUi
