...
Q_CONSTINIT const QMetaObject signupDialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSsignupDialogENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_securityCode_btn_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void signupDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_securityCode_btn_clicked(); break;
        ...
        case 4: _t->on_confirm_btn_clicked(); break;
        ...
        {
            using _t = void (signupDialog::*)();
            if (_t _q_method = &signupDialog::backToLogin; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (signupDialog::*)();
            if (_t _q_method = &signupDialog::sigSwitchLogin; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void signupDialog::backToLogin()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void signupDialog::sigSwitchLogin()
{
