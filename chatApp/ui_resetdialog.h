...
public:
    ...
    void setupUi(QDialog *ResetDialog)
    {
        ...
        user_lb->setMinimumSize(QSize(80, 25));
        user_lb->setMaximumSize(QSize(80, 25));
        ...
        email_lb->setMinimumSize(QSize(80, 25));
        email_lb->setMaximumSize(QSize(80, 25));
        ...
        varify_lb->setMinimumSize(QSize(80, 25));
        varify_lb->setMaximumSize(QSize(80, 25));
        ...
        pwd_lb->setMinimumSize(QSize(80, 25));
        pwd_lb->setMaximumSize(QSize(80, 25));
    ...
    void retranslateUi(QDialog *ResetDialog)
    {
        ...
        user_lb->setText(QCoreApplication::translate("ResetDialog", "User Name", nullptr));
        email_lb->setText(QCoreApplication::translate("ResetDialog", "Email", nullptr));
        varify_lb->setText(QCoreApplication::translate("ResetDialog", "Security Code", nullptr));
        varify_btn->setText(QCoreApplication::translate("ResetDialog", "Send", nullptr));
        pwd_lb->setText(QCoreApplication::translate("ResetDialog", "New Password", nullptr));
