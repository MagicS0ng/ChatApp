...
public:
    ...
    void setupUi(QDialog *ApplyFriend)
    {
        ...
        name_ed = new CustomizedEdit(apply_wid);
    ...
    void retranslateUi(QDialog *ApplyFriend)
    {
        ...
        apply_lb->setText(QCoreApplication::translate("ApplyFriend", "New Friends", nullptr));
        label->setText(QCoreApplication::translate("ApplyFriend", "Send friend request", nullptr));
        label_2->setText(QCoreApplication::translate("ApplyFriend", "alias:", nullptr));
        label_3->setText(QCoreApplication::translate("ApplyFriend", "tags", nullptr));
        tip_lb->setText(QCoreApplication::translate("ApplyFriend", "TextLabel", nullptr));
        more_lb->setText(QString());
        sure_btn->setText(QCoreApplication::translate("ApplyFriend", "Confirm", nullptr));
        cancel_btn->setText(QCoreApplication::translate("ApplyFriend", "Cancel", nullptr));
    } // retranslateUi
